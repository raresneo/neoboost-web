...
export const EXTENDED_PROGRAMS: ExtendedProgram[] = [
    {
        ...
        reward3Plus1: {
            ...
            description: "Dacă după acest program decizi să continui și menții prezența și obiectivele, primești o recompensă de loialitate sub formă de sesiuni bonus sau discount la abonamentul curent."
        },
    ...
    },
    {
        ...
        video: "https://youtube.com/shorts/4Juc9i0ehqY",
        gallery: [
            "/Anca_Meda.webp",
            "/Anca_Meda_3.webp",
            "/Anca_Meda_4.webp",
            "/Anca_Meda_5.webp",
            "/Anca_Meda.webp",
            "https://youtube.com/shorts/Nh-DcuWCCmU" // Masaj Anca Video
        ],
        forWho: {
            ideal: [
        ...
        reward3Plus1: {
            ...
            description: "Dacă după programul de 8 săptămâni continui să te antrenezi cu noi și îndeplinești condițiile, primești sesiuni bonus cadou. Recompensăm procesul și grija față de corp."
        },
        participationConditions: [
    ...
    },
    {
        ...
        reward3Plus1: {
            ...
            description: "Dacă alegeți un pachet standard de antrenament și îndepliniți condițiile, vă oferim sesiuni extra din partea noastră pentru a vă susține progresul."
        },
        participationConditions: [
    ...
    },
    {
        ...
        reward3Plus1: {
            ...
            description: "Vrei să continui după cele 8 săptămâni? Dacă menții consistența și îndeplinești condițiile, ai o recompensă specială din partea noastră. Este modul nostru de a premia munca, nu genetica."
        },
        participationConditions: [
    ...
    },
    {
        ...
        reward3Plus1: {
            ...
            conditions: [
                "Respectă procesul",
                "Atingi obiectivul inițial"
            ],
            description: "Dacă decizi să transformi acest \"trial\" într-un stil de viață și alegi un pachet standard, beneficiezi de un bonus de loialitate. Simplu. Corect."
        },
        participationConditions: [
    ...
    },
    {
        ...
        includes: [
            ...
            "Setare Obiective și Calendar: Știi exact ce faci în următoarea perioadă"
        ],
        pricing: {
        ...
        reward3Plus1: {
            ...
            description: "Dacă \"absolvi\" On-Boarding-ul și continui cu antrenamentele, primești o sesiune de evaluare avansată cadou. Un start bun merită premiat."
        },
        participationConditions: [
            "Dorința de a învăța",
