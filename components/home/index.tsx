    ...
    <Section id="beneficii">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {UNIFIED_BENEFITS.map((b) => (
                <div
                    key={b.id}
                    className="group relative flex flex-col rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--bg-primary)] p-7 transition-all duration-150 hover:-translate-y-1 hover:border-[var(--accent-primary)] hover:shadow-[var(--shadow-lg)]"
                >
                    {(b as any).badge && (
    ...
    <Section id="metoda">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {EMS_STEPS.map((s) => (
                <div
                    key={s.id}
                    className="relative rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--bg-primary)] p-7"
                >
