...
export const PowerBoxLifestyle = () => (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden bg-black/80 rounded-2xl">
        ...
        <div className="relative w-full h-full scale-[1.05] transition-transform duration-700 group-hover:scale-[1.15]">
            <iframe
                src="https://www.youtube.com/embed/zelq4lbvDnw?autoplay=1&mute=1&controls=0&loop=1&playlist=zelq4lbvDnw"
...
export const TabletReal = () => (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden group bg-black/80 rounded-2xl">
        ...
        <div className="relative w-full h-full scale-[1.5] transition-transform duration-700 group-hover:scale-[1.6]">
            <iframe
                src="https://www.youtube.com/embed/HhxM2OteZNE?autoplay=1&mute=1&controls=0&loop=1&playlist=HhxM2OteZNE"
                className="w-full h-full object-cover brightness-90 pointer-events-none"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                style={{ border: 0 }}
            />
...
export const DrysuitLifestyle = () => {
    const videoSrc = "https://youtube.com/shorts/Zm-QlF8dA4M";
    const isYouTube = videoSrc.includes('youtube.com') || videoSrc.includes('youtu.be');
    const embedUrl = isYouTube
        ? (videoSrc.includes('/shorts/')
            ? videoSrc.replace('youtube.com/shorts/', 'www.youtube.com/embed/') + '?autoplay=1&mute=1&loop=1&playlist=' + videoSrc.split('/').pop()
            : videoSrc.replace('watch?v=', 'embed/') + '?autoplay=1&mute=1&loop=1')
        : videoSrc;
