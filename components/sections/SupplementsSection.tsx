...
export const SupplementsSection = () => {
    ...
    return (
        <section className="py-24 bg-[var(--bg-primary)] relative overflow-hidden z-20">
            {/* Background elements */}
            <div className="absolute top-0 right-0 w-1/2 h-full bg-blue-500/5 blur-[120px] z-0 pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 w-1/2 h-full bg-red-500/5 blur-[120px] z-0 pointer-events-none"></div>
            ...
            <div className="container mx-auto px-6 md:px-24 relative z-30">
                ...
                <div className="text-center mb-20">
                    <ScrollReveal>
                        ...
                        <h2 className="text-4xl md:text-6xl font-display font-bold text-[var(--text-primary)] uppercase italic mb-6">
                    ...
                    <div className="space-y-20">
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <ScrollReveal direction="left">
                                <h3 className="text-3xl font-display font-bold text-[var(--text-primary)] uppercase mb-6">
                                    Fiecare corp este diferit. <br />
                                    <span className="text-[var(--text-muted)]">De ce suplimentele tale ar fi la fel?</span>
                                </h3>
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <div className="flex items-center gap-2 px-4 py-2 bg-[var(--bg-secondary)] rounded-lg border border-[var(--border-subtle)]">
