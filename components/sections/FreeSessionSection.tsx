...
export const FreeSessionSection = () => {
    return (
        <section id="sedinta-gratuita" className="py-20 bg-[var(--bg-primary)]">
                ...
                <ScrollReveal>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-[var(--text-primary)] uppercase italic mb-6">
                                Ședința <span className="text-blue-600">Gratuită</span>.
                                <span className="block text-2xl md:text-3xl text-[var(--text-muted)] mt-2 not-italic font-medium">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            {/* Card 1: Durata */}
                            <div className="bg-[var(--bg-secondary)] p-8 rounded-3xl border border-blue-500/20 shadow-xl shadow-blue-500/10 hover:-translate-y-1 transition-transform duration-300">
                                <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center text-blue-600 mb-6">
                                    <Clock size={24} />
                                </div>
                                <h3 className="text-xl font-black text-[var(--text-primary)] uppercase mb-3">30 Minute Total</h3>
                            ...
                            <div className="bg-[var(--bg-secondary)] p-8 rounded-3xl border border-blue-500/20 shadow-xl shadow-blue-500/10 hover:-translate-y-1 transition-transform duration-300">
                                ...
                                <h3 className="text-xl font-black text-[var(--text-primary)] uppercase mb-3">Totul Inclus</h3>
                                <p className="text-[var(--text-secondary)] leading-relaxed">
                            ...
                            <div className="bg-[var(--bg-secondary)] p-8 rounded-3xl border border-blue-500/20 shadow-xl shadow-blue-500/10 hover:-translate-y-1 transition-transform duration-300">
                                ...
                                <h3 className="text-xl font-black text-[var(--text-primary)] uppercase mb-3">Activare 90%</h3>
                                <p className="text-[var(--text-secondary)] leading-relaxed">
                            ...
                            <div className="bg-[var(--bg-secondary)] p-8 rounded-3xl border border-blue-500/20 shadow-xl shadow-blue-500/10 hover:-translate-y-1 transition-transform duration-300">
                                ...
                                <h3 className="text-xl font-black text-[var(--text-primary)] uppercase mb-3">Plan Personalizat</h3>
                                <p className="text-[var(--text-secondary)] leading-relaxed">
