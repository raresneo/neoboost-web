...
import { EMS_SOLUTIONS } from '../../constants';// --- Science & Solutions Section ---
            ...
            <ScrollReveal>
                <div className="mb-16 max-w-3xl">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <span className="mono-font text-[#3A86FF] uppercase tracking-[0.3em] text-[10px] font-black">
                            <TextScramble text="Probleme & Soluții" />
                        </span>
                    </div>
                    <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-6 heading-glow uppercase italic leading-[1.1]">
                        <TextScramble text="ȘTIINȚA" /> <span className="text-[#3A86FF]">REZULTATELOR.</span>
                    </h2>
