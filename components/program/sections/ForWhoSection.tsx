        ...
        <section className="py-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="glass-block p-10 border-[#3A86FF]/20 rounded-3xl">
                    <h3 className="text-2xl font-black impact-font uppercase text-[#3A86FF] mb-8 flex items-center gap-3">
                ...
                <div className="glass-block p-10 border-red-500/20 rounded-3xl">
                    <h3 className="text-2xl font-black impact-font uppercase text-red-400 mb-8 flex items-center gap-3">
                        <XCircle size={28} />
                        NU ESTE PENTRU
                    </h3>
                    <ul className="space-y-4">
