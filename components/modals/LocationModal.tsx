...
export const LocationModal: React.FC<LocationModalProps> = ({ location, isOpen, onClose }) => {
    ...
    return (
        <div
            className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-xl animate-fade-in"
            onClick={(e) => {
                if (isZoomed) setIsZoomed(false);
                else onClose();
            }}
        >
            ...
            {isZoomed && (
                ...
                >
                    <img
                        src={gallery[activeImage] || location.gallery?.[0] || '/ramada_ems_1.webp'}
                        alt="Zoomed view"
            ...
            <div
                className={`relative w-full max-w-7xl max-h-[95vh] overflow-y-auto bg-white border border-gray-200 rounded-3xl shadow-2xl animate-scale-in ${isZoomed ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="absolute top-6 right-6 z-50 p-3 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full text-gray-400 hover:text-white hover:bg-[#3A86FF] hover:border-[#3A86FF] transition-all duration-300 group"
                >
                ...
                <div className="p-8 md:p-12">
                    {/* Header */}
                    <div className="mb-12">
                        <h2 className="text-5xl md:text-7xl font-display font-bold text-gray-900 mb-4 leading-tight">
                            {location.name}
                        </h2>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Galerie Foto</h3>

                            {/* Main Image */}
                            <div
                                className="relative aspect-video overflow-hidden rounded-2xl border border-gray-200 group cursor-zoom-in"
                            ...
                            {/* Perks */}
                            <div className="mt-8">
                                <h3 className="text-xl font-bold text-gray-900 mb-4">Facilități</h3>
                        ...
                        <div className="space-y-6">
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Programează-te Acum</h3>
