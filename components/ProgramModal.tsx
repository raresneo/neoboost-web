...
export const ProgramModal: React.FC<ProgramModalProps> = ({ program, onClose, FORM_CONFIGS, StepForm }) => {
    ...
    const mockBeforeAfter = program.id === 'fit-mamma' ? '/transformation_female_v2.webp' : '/transformation_male_v2.webp';
    ...
    const getHeroImage = (id: string) => {
        switch (id) {
            case 'kickstart': return '/Cems2.webp';
            case 'fit-mamma': return '/Cems1.webp';
            case '8-week-transform': return '/Cems3.jpg';
            case 'toning': return '/Cems1.webp';
                            ...
                            <section>
                                ...
                                <div className="grid md:grid-cols-2 gap-8 items-center bg-white/5 rounded-3xl overflow-hidden border border-white/10">
                                    <div className="aspect-square">
                                        <img src="/Cems1.webp" alt="EMS Suit Detail" className="w-full h-full object-cover hi-fi-image" />
                                    </div>
