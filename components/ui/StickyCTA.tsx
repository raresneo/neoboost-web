...
export const StickyCTA = () => {
    ...
    return (
        <a
            ...
            className={`fixed bottom-24 right-4 z-[90] flex h-14 w-14 items-center justify-center rounded-full text-white shadow-[0_8px_24px_rgba(37,211,102,0.45)] transition-all duration-300 hover:scale-110 active:scale-95 md:right-6 xl:bottom-6
