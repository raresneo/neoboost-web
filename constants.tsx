...
export const TEAM = [
    { id: 'rares-pantis', name: 'Rareș Pantiș', role: 'Fondator & Head Coach', signatureSkill: 'Visionary Architecture', image: '/rares_pantis.webp', quote: "Viziunea mea este să ofer oamenilor timp. Timp pentru ei, pentru sănătate, într-o lume care ne fură fiecare secundă.", description: "Povestea mea începe cu o valiză și un vis. Am strâns fiecare leu ca antrenor pentru a cumpăra primul aparat EMS. Căram echipamentul dintr-un apartament în altul, construind totul pas cu pas. Am ajuns să gestionez singur 40 de clienți activi, moment în care am realizat că pentru a ajuta mai mulți oameni, trebuie să cresc. Așa s-a născut prima echipă. Astăzi, NeoBoost nu mai este despre 'one-man show', ci despre o comunitate de peste 5.000 de oameni fericiți și o echipă unită de empatie și viziune.", socials: { instagram: 'https://www.instagram.com/pantis.rares?igsh=a2FzMTk1Nmpsdzhi&utm_source=qr', linkedin: 'https://www.linkedin.com/in/pantis-rares-99ba21242/' }, type: 'founder' },
    { id: 'rares-silvasan', name: 'Rareș Silvășan', role: 'EMS Trainer', signatureSkill: 'Precision Mechanics', image: '/rares_silvasan_new.webp', quote: "Succesul vine din implicare, răbdare și motivație constantă. Împreună transformăm obiectivele în realitate.", description: "Sunt un antrenor dedicat, pasionat de sport și de progresul fiecărui client. Deși am început recent pregătirea specifică pentru culturism, am o experiență solidă în fitness și EMS, fiind activ implicat în tot ce înseamnă viața acestui studio. Mă remarc prin răbdare – îți voi explica fiecare exercițiu până îl stăpânești perfect – și prin adaptabilitate. Indiferent de nivelul tău, sunt aici să te motivez, să îți ofer un exemplu personal și să te inspir să îți depășești limitele. Îmi place să văd evoluția clienților mei și mă implic activ în susținerea lor, pas cu pas.", socials: { instagram: 'https://www.instagram.com/silvasan_rares?igsh=MWU0YjFicTA0ajBhcg==' }, type: 'trainer' },
    { id: 'alex-cret', name: 'Alex Creț', role: 'Level 4 PT', signatureSkill: 'Calisthenics Specialist', image: '/alex_cret.webp', quote: "Corpul tău este cel mai bun echipament. Pentru mine, NeoBoost este o familie unde ne ridicăm unii pe alții.", description: "Cred cu tărie că propriul corp este cel mai bun 'aparat' pe care îl deținem. Ca specialist în Calisthenics, am învățat că forța adevărată vine din control și echilibru. La NeoBoost, combin această filozofie cu tehnologia EMS pentru a te ajuta să te miști mai bine și fără dureri. Fie vorba de recuperare sau de performanță, sunt aici să mă asigur că fiecare antrenament este sigur și eficient. Pentru mine, nu ești doar un client, ești un coechipier.", socials: { instagram: 'https://www.instagram.com/alexcretr?igsh=MXgxZ3QzbDFzeGp0NA==' }, type: 'trainer' },
    { id: 'ionut-maris', name: 'Ionuț Mariș Hinsu', role: 'Level 4 PT', signatureSkill: 'Transformation Expert', image: '/ionut_maris.webp', storyImage: '/ionut_story_client.webp', quote: "Am slăbit 12kg la NeoBoost și mi-am schimbat viața. Sunt antrenorul care a fost în locul tău știe exact cum să te susțină.", description: "Povestea mea aici a început simplu: ca client. Eram lipsit de energie și nemulțumit de forma mea. Am reușit să slăbesc 12 kg și acea transformare mi-a schimbat complet perspectiva, motivându-mă să devin antrenor. Știu exact cum e să îți fie greu la început, știu cum e să vrei să renunți. De aceea, sunt aici să te susțin nu doar cu exerciții, ci și cu înțelegere. Dacă eu am reușit, te asigur că și tu poți.", socials: { instagram: 'https://www.instagram.com/maris_hinsu_ionut?igsh=MWxjd3EwODV2dXptMw==' }, type: 'trainer' },
    { id: 'raluca-zaro', name: 'Raluca Zaro', role: 'Marketing Director', signatureSkill: 'Community Architect', image: '/raluca_zaro.webp', quote: "Branding autentic, bazat pe realitate, nu pe idealizări. Aici construim o cultură, nu doar o imagine.", description: "Misiunea mea la NeoBoost este să traduc tehnologia într-o limbă pe care o înțelegem cu toții: emoția. Cu un background în Psihologie, încerc să construiesc o comunitate reală, nu doar o imagine frumoasă pe Instagram. Vreau ca fiecare persoană care ne trece pragul sau ne vede online să simtă valorile noastre: căldura, onestitatea și dorința de a ajuta. Aici nu e vorba despre aparate, ci despre oamenii care le folosesc și poveștile lor.", socials: { instagram: 'https://www.instagram.com/raluca_zaro?igsh=MXVqM2p3ZnY0ajN1YQ==' }, type: 'marketing' },
];
