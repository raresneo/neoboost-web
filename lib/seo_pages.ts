...
export const SEO_PAGES: SeoPageConfig[] = [
    // 1. Antrenament Cluster (Local)
    {
        ...
        intent: 'local',
        cluster: 'antrenament',
        title: 'Antrenament EMS Oradea – NeoBoost Studio',
        description: 'Vrei rezultate rapide? Antrenamentul EMS de 30 minute echivalează cu 4 ore de sală clasică. Rezervă o ședință la cel mai avansat studio din Oradea.',
        priority: 'H',
        secondaryKeywords: [
    ...
    // 2. Slăbire Cluster (Commercial)
    {
        ...
        intent: 'commercial',
        cluster: 'slăbire',
        title: 'Slăbire EMS Oradea – Program pentru Rezultate Rapide',
        description: 'Elimină grăsimea și celulita cu tehnologia EMS. Program personalizat de slăbire în ședințe de 30 minute. Arzi până la 2500 calorii!',
        priority: 'H',
        secondaryKeywords: [
            'EMS slăbire Oradea',
    ...
    // 3. Sesiune / Trial Cluster (Informational/Commercial) -> Using Informational layout with strong CTAs
    {
        ...
        cluster: 'sesiune',
        title: 'Prima Ședință EMS – Ghid și Ofertă Gratuită',
        description: 'Ești curios cum funcționează? Află tot ce trebuie să știi despre prima ta sesiune EMS la NeoBoost. Prima ședință este GRATUITĂ!',
        priority: 'H',
        secondaryKeywords: [
            'sesiune EMS Oradea',
    ...
    // 4. Preturi Cluster (Commercial)
    {
        ...
        intent: 'commercial',
        cluster: 'pret',
        title: 'Prețuri Abonamente EMS Oradea – Oferte NeoBoost',
        description: 'Vezi lista completă de prețuri pentru antrenamentele EMS NeoBoost Oradea. Abonamente flexibile, pachete de transformare și oferte speciale.',
        priority: 'H',
        secondaryKeywords: [
            'EMS preț Oradea',
            'preț sesiune EMS',
    ...
    // 6. General/Brand Cluster (Local/Informational)
    {
        ...
        intent: 'local',
        cluster: 'general',
        title: 'EMS Oradea – Tehnologie Wireless pentru Transformare',
        description: 'Antrenează-te inteligent cu NeoBoost EMS Oradea. 30 de minute pentru un corp tonifiat. Tehnologie wireless și antrenori dedicați.',
        priority: 'H',
        secondaryKeywords: [
            'EMS fitness Oradea'
        ]
    ...
    // 7. Abonamente Cluster (Commercial)
    {
        ...
        description: 'Alege abonamentul care ți se potrivește. De la pachete Starter la transformări complete de 8 săptămâni. Flexibilitate și rezultate.',
        priority: 'H',
        secondaryKeywords: [
